# Generated by Django 5.1.2 on 2024-11-17 20:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Second Last Name')),
                ...
                ('user_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='user.usertype')),
            ],
            options={
                'verbose_name': 'user',
